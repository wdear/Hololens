...
/// </summary>
/// 
public class GestureAction_draw : MonoBehaviour
{
    ...
    {
        PerformRotation();
        GameObject cube = GameObject.Find("rack");
        if (cube.transform.position.z - transform.position.z < 0.15f)
        {
            canvasDrawer.SetActive(false);
        }
        else
