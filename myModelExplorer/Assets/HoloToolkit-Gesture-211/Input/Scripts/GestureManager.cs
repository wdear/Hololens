...
namespace Academy.HoloToolkit.Unity
{
    ...
    {
        public GestureRecognizer DoubleTapRecognizer;
        ...
        void Awake()
        {
            ...
            ////  订阅手势事件  
            //DoubleTapRecognizer.TappedEvent += DoubleTapRecognizer_TappedEvent;
        ...
        ManipulationRecognizer = new GestureRecognizer();
            ...
            ManipulationRecognizer.TappedEvent += ManipulationRecognizerr_TappedEvent;
        ...
        private void ManipulationRecognizerr_TappedEvent(InteractionSourceKind source, int tapCount, Ray ray)
        {
        ...
        private void OnTap()
        {
            ...
            if (focusedObject != null)
            {
                focusedObject.SendMessageUpwards("OnTap");
